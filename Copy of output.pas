...
begin
     ...
     begin
          ...
          font.style:=[];
          font.height:=round(-font.height*fontscle);
          textout(trunc(scle*0.4),trunc(scle*line),'10930 E. BURT RD. | EL PASO, TX 79927');
          line:=line+font.height/scle;
          textout(trunc(scle*0.4),trunc(scle*line),'PHONE (915)726-6285 | FAX (01152656)648-6083');
          line:=line2;
          textout(trunc(scle*3.75),trunc(scle*line),'PROF. FCA. GOMEZ VELETA 7801 | INFONAVIT FRONTERA NUEVA');
          line:=line+font.height/scle;
          textout(trunc(scle*3.75),trunc(scle*line),'CD. JUAREZ, CHIH. 32420 | TEL (656)648-6080,81 FAX (656)648-6083');
     end;
end;
...
begin
     ...
     begin
          ...
          begin
               ...
               font.style:=[fsbold];
               line:=line+font.height/scle;
               textout(trunc(scle*0.3),trunc(scle*line),'Stress Analysis Summary');
               line:=line+font.height/scle;
